...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    className: "container max-w-6xl p-8",
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
        className: "mb-3 py-6 w-full flex flex-col justify-between bg-gray-800",
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", {
            className: "text-2xl text-gray-400 font-normal",
            children: "TxPipe Starter Kit"
          }, void 0, false, {
            fileName: "app/routes/index.tsx",
            lineNumber: 36,
            columnNumber: 17
...
//# sourceMappingURL=/build/routes/index-2DVKOGKC.js.map
